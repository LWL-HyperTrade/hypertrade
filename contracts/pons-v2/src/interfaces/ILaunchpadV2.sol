 ...
 */
interface IBuilderPadFeeEscrow {
 ...
 */
interface IBuilderPadFeePolicy {
    ...
    function feeEscrow() external view returns (IBuilderPadFeeEscrow);
 ...
 * BuilderPadLaunchFactory as owner-mutable settings that govern launches from
...
/**
 * @notice Record kept by BuilderPadLaunchFactory for every launch, readable by
 * the locker and by off-chain indexers.
 */
interface IBuilderPadLaunchFactory {
 ...
 */
interface IBuilderPadBondingCurve {
